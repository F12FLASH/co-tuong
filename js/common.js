...
com.init = function (stype){
	...
	com.spaceY			=	stype.spaceY;		//Khoảng tác động Y;
	...
	com.canvas			=	document.getElementById("chess"); //Tranh sơn dầu
	...
	com.loadImages(com.page);		//Tải thư mục ảnh / ảnh
	//z(com.initMap.join())
}
...
com.stype = {
	stype1:{
		width:325,		//Chiều rộng canvas
		height:402, 		//Chiều cao canvas
		spaceX:35,		//Khoảng tác động X
		spaceY:36,		//Khoảng tác động Y
		pointStartX:5,		//Tọa độ X của điểm đầu tiên;
		pointStartY:19,		//Tọa độ Y của điểm đầu tiên;
		page:"stype_1"	//Danh mục hình ảnh
	},
	stype2:{
		width:523,		//Chiều rộng canvas
		height:580, 		//Chiều cao canvas
		spaceX:57,		//Khoảng tác động X
		spaceY:57,		//Khoảng tác động Y
		pointStartX:3,		//Tọa độ X của điểm đầu tiên;
		pointStartY:5,		//Tọa độ Y của điểm đầu tiên;
		page:"stype_2"	//Danh mục hình ảnh
	},
	stype3:{
		width:530,		//Chiều rộng canvas
		height:567, 		//Chiều cao canvas
		spaceX:57,		//Khoảng tác động X
		spaceY:57,		//Khoảng tác động Y
		pointStartX:-2,		//Tọa độ X của điểm đầu tiên;
		pointStartY:0,		//Tọa độ Y của điểm đầu tiên;
		page:"stype_3"	//Danh mục hình ảnh
	}
}
//Nhận ID
com.get = function (id){
...
com.loadImages = function(stype){
	...
	document.getElementsByTagName("body")[0].style.background= "url(img/nengach.jpg)";
...
//Heizi là sự đảo ngược giá trị của chữ cái đỏ tươi
